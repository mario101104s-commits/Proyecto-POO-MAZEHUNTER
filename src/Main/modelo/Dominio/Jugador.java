 ...
 *<p>
 * Esta clase contiene la lógica para las interacciones básicas del jugador con el entorno,
...
public class Jugador {
     ...
     * <p>
     * Inicializa la posición en (0, 0) y establece los atributos iniciales del juego.
     *</p>
    ...
    //Metodos
    /**
     * Mueve la posición del jugador sumando los deltas proporcionados a las coordenadas actuales.
     *
    ...
    /**
     * Aplica el daño de una trampa, reduciendo la vida en 20 puntos, sin que la vida sea negativa.
     */
     ...
     *
     * @return {@code true} si la vida es mayor a cero, {@code false} si el jugador ha muerto.
     */
    ...
    /**
     * Establece la vida del jugador, asegurando que el valor se mantenga en el rango de 0 a 100.
     *
