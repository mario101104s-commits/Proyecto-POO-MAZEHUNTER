 ...
 * <p>
 * Esta clase actúa como un intermediario técnico para iniciar el entorno de JavaFX.
 * Su propósito principal es separar el punto de entrada estático {@code main} de la
 * clase que extiende {@code Application}, evitando así advertencias de configuración
...
public class Main {
     ...
     * <p>
     * Utiliza reflexión para cargar dinámicamente {@link MainApp} y ejecutar su metodo
     * principal, asegurando una inicialización limpia del toolkit gráfico.
     * </p>
     * * @param args Argumentos de la línea de comandos pasados durante la ejecución.
     */
